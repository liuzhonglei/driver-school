...
function loadPage(e){
    ...
    $.ajax({
        ...
        error:function(e,n,r){
            t.html('<h4 style="margin-top:90px;"><i class="fa fa-warning"></i> Error 404! Page not found.</h4>')},async:!1})}
function dropSidebarShadow(){
    if($(".nav-sidebar").length)
        var e=$(".nav-sidebar").offset().top-$(".sidebar").offset().top;e<60?$(".sidebar-header").addClass("drop-shadow"):
        $(".sidebar-header").removeClass("drop-shadow");
        var t=$(window).height()-$(".nav-sidebar").outerHeight()-e;t<130?$(".sidebar-footer").addClass("drop-shadow"):
...
function activeCharts(){
    if($(".boxchart").length)if(retina()){$(".boxchart").sparkline("html",{type:"bar",height:"60",barWidth:"8",barSpacing:"2",barColor:"#ffffff",negBarColor:"#eeeeee"});
        ...
        $(".boxchart").sparkline("html",{type:"bar",height:"30",barWidth:"4",barSpacing:"1",barColor:"#ffffff",negBarColor:"#eeeeee"});
    if($(".linechart").length)
        if(retina()){
            ...
            if(jQuery.browser.mozilla)
                if(!navigator.userAgent.match(/Trident\/7\./)){$(".linechart").css("MozTransform","scale(0.5,0.5)").css("height","30px;");
                ...
                }else $(".linechart").css("zoom",.5)}else $(".linechart").sparkline("html",{width:"65",height:"30",lineColor:"#ffffff",fillColor:!1,spotColor:!1,maxSpotColor:!1,minSpotColor:!1,spotRadius:2,lineWidth:1});
    $(".chart-stat").length&&(retina()?$(".chart-stat > .chart").each(function(){var e=$(this).css("color");$(this).sparkline("html",{width:"180%",height:80,lineColor:e,fillColor:!1,spotColor:!1,maxSpotColor:!1,minSpotColor:!1,spotRadius:2,lineWidth:2});
        if(jQuery.browser.mozilla)
            if(!navigator.userAgent.match(/Trident\/7\./)){$(this).css("MozTransform","scale(0.5,0.5)");
                $(this).css("height","40px;").css("margin","-20px 0px -20px -25%")
            }else $(this).css("zoom",.5);else $(this).css("zoom",.5)}):$(".chart-stat > .chart").each(function(){var e=$(this).css("color");
...
function todoList(){
    ...
    $(".todo-list-tasks > li > label > .custom-checkbox").change(function(){$(this).parent().parent().clone().appendTo(".completed").addClass("disabled").find(".custom-checkbox").attr("disabled",!0);$(this).parent().parent().slideUp("slow",function(){$(this).remove()})});
    $(".todo-list").disableSelection()
}
function discussionWidget(){
    $(".discussions").find(".delete").click(function(){$(this).parent().fadeTo("slow",0,function(){$(this).slideUp("slow",function(){$(this).remove()})})})
}
function widthFunctions(e){
    $(".timeline")&&$(".timeslot").each(function(){var e=$(this).find(".task").outerHeight();$(this).css("height",e)});
    var t=$(".navbar").outerHeight(),n=$("footer").outerHeight(),r=$(window).height(),i=$(window).width();
    $(".sidebar-menu").css("height",r-200);i<992&&$("body").removeClass("sidebar-minified");i>768&&$(".main").css("min-height",r-n)}$.ajaxLoad=!1;
var cssArray={};
if($.ajaxLoad){paceOptions={elements:!1,restartOnRequestAfter:!1};url=location.hash.replace(/^#/,"");
...
$(document).ready(function(e){
    ...
    e("#myTab a").click(function(t){t.preventDefault();e(this).tab("show")});
    ...
    e(".btn-close").click(function(t){t.preventDefault();e(this).parent().parent().parent().fadeOut()});
    ...
    e(".btn-setting").click(function(t){
        t.preventDefault();e("#myModal").modal("show")
    })
});
$(".sidebar-menu").scroll(function(){dropSidebarShadow()});$(window).bind("resize",widthFunctions);
