$(document).ready(function () {
    ...
    $('#table').bootstrapTable({
        toolbar: '#toolbar',
        url: '/api/cadetpays/_search/cadetpays',
    ...
    methods:{
        update: function(event){
            if (editValidator.form()){
                service.saveOrUpdateCadetPay(JSON.stringify(this.editReq));
            }
        },
        delete: function(){
            ...
            if(selections != null && selections.length == 1){
                ...
                service.deleteCadetpay(JSON.stringify(object));
            }
        }
    }
});
...
window.operateEvents = {
    'click .edit-click': function (e, value, row, index) {
        ...
        if (selections.length == 0){
            ...
            vm.editReq.content.payAmount = selections[0].payAmount;
            vm.editReq.content.payDatetime = selections[0].payDatetime;
