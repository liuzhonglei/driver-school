    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-laptop"></i>学员缴费信息管理</li>
            </ol>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="editModalLabel">编辑学员缴费信息</h4>
            </div>
            <div class="modal-body">
                <form id = "edit-form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="payAmount-edit" class="col-sm-2 control-label">缴费金额</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="payAmount-edit" name="idcardNum" v-model="editReq.content.payAmount" placeholder="缴费金额">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="payDatetime-edit" class="col-sm-2 control-label">缴费日期</label>
                        <div class="col-sm-10 input-group date" id="datetimepicker-edit">
                            <input type='text' id="payDatetime-edit" class="form-control" name="birthday" v-model="editReq.content.payDatetime"/>
