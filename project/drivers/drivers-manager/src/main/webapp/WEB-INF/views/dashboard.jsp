...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/plugins/fullcalendar/dist/fullcalendar.min.css" />
    <style type='text/css'>
        .ui-datepicker
        {
            width: 23em;
...
<body>
    ...
    <div class="main">
        ...
        <div class="row" >
            <h4 class="text-center">欢迎光临眉山市瑞达驾校后台管理系统</h4>
        </div>
        <div class="row">
            <div id="wrap">
                <div id='calendar'>
    ...
    <script src='${ctx}/plugins/moment/min/moment.min.js'></script>
    <script src='${ctx}/plugins/fullcalendar/dist/fullcalendar.min.js'></script>
